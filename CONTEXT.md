# Porta — Domain Context

Porta is an ecosystem toolchain portal: a public-facing website whose primary
users are internal employees. It catalogs tools, courses, teaching videos, and
model API resources behind one generic content system. This file defines the
project's shared vocabulary; use these words with these meanings in code,
docs, and discussion.
